...
<body>
    ...
    <section class="menu__category">
        <div class="category__items">
            <div class="category__product btn category__btn" style="background:#382620;"><a href="<?php echo get_permalink( get_page_by_path('menu/pasta') ); ?>">パスタ</a></div>
            <div class="category__product btn category__btn"><a href="<?php echo get_permalink( get_page_by_path('menu/salad') ); ?>">サラダ</a></div>
            <div class="category__product btn category__btn"><a href="<?php echo get_permalink( get_page_by_path('menu/pans-sweets') ); ?>">パン&<br>スイーツ</a></div>
    ...
    <section class="menu__items">
        <div class="menu__item">
            <div class="grand__menu__set menu__set">
                <div class="grand__menu__item__img menu__set__img"><img src="<?php echo get_template_directory_uri() ?>/img/menu/img_pasta1@2x.png" alt=""></div>
                <div class="grand__menu__item__title menu__set__title">テキストテキストテキストの○○○○風パスタ</div>
                <div class="grand__menu__item__price menu__set__price">780 yen</div>
            </div>
            <!-- /.grand__menu__set -->
            <div class="grand__menu__set menu__set">
                <div class="grand__menu__item__img menu__set__img"><img src="<?php echo get_template_directory_uri() ?>/img/menu/img_pasta2@2x.png" alt=""></div>
                <div class="grand__menu__item__title menu__set__title">テキストテキストテキストの○○○○風パスタ</div>
                <div class="grand__menu__item__price menu__set__price">780 yen</div>
            </div>
            <!-- /.grand__menu__set -->
            <div class="grand__menu__set menu__set">
                <div class="grand__menu__item__img menu__set__img"><img src="<?php echo get_template_directory_uri() ?>/img/menu/img_pasta3@2x.png" alt=""></div>
                <div class="grand__menu__item__title menu__set__title">テキストテキストテキストの○○○○風パスタ</div>
                <div class="grand__menu__item__price menu__set__price">780 yen</div>
            </div>
            <!-- /.grand__menu__set -->
            <div class="grand__menu__set menu__set">
                <div class="grand__menu__item__img menu__set__img"><img src="<?php echo get_template_directory_uri() ?>/img/menu/img_pasta4@2x.png" alt=""></div>
                <div class="grand__menu__item__title menu__set__title">テキストテキストテキストの○○○○風パスタ</div>
                <div class="grand__menu__item__price menu__set__price">780 yen</div>
            </div>
            <!-- /.grand__menu__set -->
            <div class="grand__menu__set menu__set">
                <div class="grand__menu__item__img menu__set__img"><img src="<?php echo get_template_directory_uri() ?>/img/menu/img_pasta5@2x.png" alt=""></div>
                <div class="grand__menu__item__title menu__set__title">テキストテキストテキストの○○○○風パスタ</div>
                <div class="grand__menu__item__price menu__set__price">780 yen</div>
            </div>
            <!-- /.grand__menu__set -->
            <div class="grand__menu__set menu__set">
                <div class="grand__menu__item__img menu__set__img"><img src="<?php echo get_template_directory_uri() ?>/img/menu/img_pasta6@2x.png" alt=""></div>
                <div class="grand__menu__item__title menu__set__title">テキストテキストテキストの○○○○風パスタ</div>
                <div class="grand__menu__item__price menu__set__price">780 yen</div>
            </div>
            <!-- /.grand__menu__set -->
            <div class="grand__menu__set menu__set">
                <div class="grand__menu__item__img menu__set__img"><img src="<?php echo get_template_directory_uri() ?>/img/menu/img_pasta7@2x.png" alt=""></div>
                <div class="grand__menu__item__title menu__set__title">テキストテキストテキストの○○○○風パスタ</div>
                <div class="grand__menu__item__price menu__set__price">780 yen</div>
            </div>
            <!-- /.grand__menu__set -->
            <div class="grand__menu__set menu__set">
                <div class="grand__menu__item__img menu__set__img"><img src="<?php echo get_template_directory_uri() ?>/img/menu/img_pasta8@2x.png" alt=""></div>
                <div class="grand__menu__item__title menu__set__title">テキストテキストテキストの○○○○風パスタ</div>
                <div class="grand__menu__item__price menu__set__price">780 yen</div>
            </div>
            <!-- /.grand__menu__set -->
            <div class="grand__menu__set menu__set">
                <div class="grand__menu__item__img menu__set__img"><img src="<?php echo get_template_directory_uri() ?>/img/menu/img_pasta9@2x.png" alt=""></div>
                <div class="grand__menu__item__title menu__set__title">テキストテキストテキストの○○○○風パスタ</div>
                <div class="grand__menu__item__price menu__set__price">780 yen</div>
            </div>
            <!-- /.grand__menu__set -->
            <div class="grand__menu__set menu__set">
                <div class="grand__menu__item__img menu__set__img"><img src="<?php echo get_template_directory_uri() ?>/img/menu/img_pasta10@2x.png" alt=""></div>
                <div class="grand__menu__item__title menu__set__title">テキストテキストテキストの○○○○風パスタ</div>
                <div class="grand__menu__item__price menu__set__price">780 yen</div>
            </div>
            <!-- /.grand__menu__set -->
            <div class="grand__menu__set menu__set">
                <div class="grand__menu__item__img menu__set__img"><img src="<?php echo get_template_directory_uri() ?>/img/menu/img_pasta11@2x.png" alt=""></div>
                <div class="grand__menu__item__title menu__set__title">テキストテキストテキストの○○○○風パスタ</div>
                <div class="grand__menu__item__price menu__set__price">780 yen</div>
            </div>
            <!-- /.grand__menu__set -->
            <div class="grand__menu__set menu__set">
                <div class="grand__menu__item__img menu__set__img"><img src="<?php echo get_template_directory_uri() ?>/img/menu/img_pasta12@2x.png" alt=""></div>
                <div class="grand__menu__item__title menu__set__title">テキストテキストテキストの○○○○風パスタ</div>
                <div class="grand__menu__item__price menu__set__price">780 yen</div>
            </div>
            <!-- /.grand__menu__set -->
            <div class="grand__menu__set menu__set">
                <div class="grand__menu__item__img menu__set__img"><img src="<?php echo get_template_directory_uri() ?>/img/menu/img_pasta13@2x.png" alt=""></div>
                <div class="grand__menu__item__title menu__set__title">テキストテキストテキストの○○○○風パスタ</div>
                <div class="grand__menu__item__price menu__set__price">780 yen</div>
            </div>
            <!-- /.grand__menu__set -->
            <div class="grand__menu__set menu__set">
                <div class="grand__menu__item__img menu__set__img"><img src="<?php echo get_template_directory_uri() ?>/img/menu/img_pasta14@2x.png" alt=""></div>
                <div class="grand__menu__item__title menu__set__title">テキストテキストテキストの○○○○風パスタ</div>
                <div class="grand__menu__item__price menu__set__price">780 yen</div>
            </div>
            <!-- /.grand__menu__set -->
