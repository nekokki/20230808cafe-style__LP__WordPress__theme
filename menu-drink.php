...
<body>
    ...
    <section class="menu__category">
        <div class="category__items">
            ...
            <div class="category__product btn category__btn" style="background:#382620;"><a href="<?php echo get_permalink( get_page_by_path('menu/drink') );; ?>">ドリンク</a></div>
        </div>
        <!-- /.category__items -->
    </section>
    <!-- /.menu__category -->
    ...
    <section class="menu__items">
        <div class="menu__item">
            <div class="grand__menu__set menu__set">
                <div class="grand__menu__item__img menu__set__img"><img src="<?php echo get_template_directory_uri() ?>/img/drink/img_drink1.jpg" alt=""></div>
                <div class="grand__menu__item__title menu__set__title">○○○○風コーヒー</div>
                <div class="grand__menu__item__price menu__set__price">780 yen</div>
            </div>
            <!-- /.grand__menu__set -->
            <div class="grand__menu__set menu__set">
                <div class="grand__menu__item__img menu__set__img"><img src="<?php echo get_template_directory_uri() ?>/img/drink/img_drink2.jpg" alt=""></div>
                <div class="grand__menu__item__title menu__set__title">オレンジジュース</div>
                <div class="grand__menu__item__price menu__set__price">780 yen</div>
            </div>
            <!-- /.grand__menu__set -->
            <div class="grand__menu__set menu__set">
                <div class="grand__menu__item__img menu__set__img"><img src="<?php echo get_template_directory_uri() ?>/img/drink/img_drink3.jpg" alt=""></div>
                <div class="grand__menu__item__title menu__set__title">いちごみるく</div>
                <div class="grand__menu__item__price menu__set__price">780 yen</div>
            </div>
            <!-- /.grand__menu__set -->
            <div class="grand__menu__set menu__set">
                <div class="grand__menu__item__img menu__set__img"><img src="<?php echo get_template_directory_uri() ?>/img/drink/img_drink4.jpg" alt=""></div>
                <div class="grand__menu__item__title menu__set__title">アイスティー</div>
                <div class="grand__menu__item__price menu__set__price">780 yen</div>
            </div>
            <!-- /.grand__menu__set -->
            <div class="grand__menu__set menu__set">
                <div class="grand__menu__item__img menu__set__img"><img src="<?php echo get_template_directory_uri() ?>/img/drink/img_drink5.jpg" alt=""></div>
                <div class="grand__menu__item__title menu__set__title">ティー</div>
                <div class="grand__menu__item__price menu__set__price">780 yen</div>
            </div>
            <!-- /.grand__menu__set -->
        </div>
