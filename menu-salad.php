...
<body>
    ...
    <section class="menu__category">
        <div class="category__items">
            ...
            <div class="category__product btn category__btn" style="background:#382620;"><a href="<?php echo get_permalink( get_page_by_path('menu/salad') ); ?>">サラダ</a></div>
    ...
    <section class="menu__items">
        <div class="menu__item">
            <div class="grand__menu__set menu__set">
                <div class="grand__menu__item__img menu__set__img"><img src="<?php echo get_template_directory_uri() ?>/img/top/img_salad1@2x.png" alt=""></div>
                <div class="grand__menu__item__title menu__set__title">○○○○風サラダ</div>
                <div class="grand__menu__item__price menu__set__price">780 yen</div>
            </div>
            <!-- /.grand__menu__set -->
            <div class="grand__menu__set menu__set">
                <div class="grand__menu__item__img menu__set__img"><img src="<?php echo get_template_directory_uri() ?>/img/top/img_salad2@2x.png" alt=""></div>
                <div class="grand__menu__item__title menu__set__title">○○○○風サラダ</div>
                <div class="grand__menu__item__price menu__set__price">780 yen</div>
            </div>
            <!-- /.grand__menu__set -->
            <div class="grand__menu__set menu__set">
                <div class="grand__menu__item__img menu__set__img"><img src="<?php echo get_template_directory_uri() ?>/img/top/img_salad3@2x.png" alt=""></div>
                <div class="grand__menu__item__title menu__set__title">○○○○風サラダ</div>
                <div class="grand__menu__item__price menu__set__price">780 yen</div>
            </div>
            <!-- /.grand__menu__set -->
